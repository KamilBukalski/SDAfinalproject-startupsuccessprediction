...
|--------|--------------------------|---------|--------------------------------------------------------------------------------------------------------------------------------------|
| 1      | age                      | int     | Amount of years from founded year up to year of closing (or 2013 as a maximum).                                                      |
...
| 4      | age_first_milestone_year | float   | Age of the company in years since it reached first milestone.                                                                        |
| 5      | age_last_milestone_year  | float   | Age of the company in years since it reached last milestone.                                                                         |
...
| 22     | has_roundA               | boolean | Parameter stating if company has had a round A in finding funding from investors.                                                    |
| 23     | has_roundB               | boolean | Parameter stating if company has had a round B in finding funding from investors.                                                    |
| 24     | has_roundC               | boolean | Parameter stating if company has had a round C in finding funding from investors.                                                    |
| 25     | has_roundD               | boolean | Series D funding is the fourth stage of fundraising that a business completes after the seed stage and all rounds of A-C completion. |
...
| Number | Name    | Type    | Description                                                                              |
|--------|---------|---------|------------------------------------------------------------------------------------------|
| 1      | labels  | boolean | True/False parameter for the company being in the top 500 companies for it's state/time. |
...
Best params: {'max_depth': 12, 'min_samples_leaf': 2, 'min_samples_split': 12, 'n_estimators': 100} <br>
Best score: 0.8840662712724029 <br>
F1 score: 0.8272727272727273 <br>
Accuarcy: 0.7738095238095238 <br>
Precision: 0.7844827586206896 <br>
Recall: 0.875

and **GradientBoosting**, with results:
Best params: {'learning_rate': 0.2, 'max_depth': 2, 'min_samples_leaf': 2, 'min_samples_split': 12, 'n_estimators': 100} <br>
Best score: 0.8910059290322788 <br>
F1 score: 0.8625592417061612 <br>
Accuarcy: 0.8273809523809523 <br>
...
or constructive feedback - please do so in a DM. In the future, we are planning to change the dataset to be based on Polish companies and to provide a dashboard, 
